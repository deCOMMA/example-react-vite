...
import {
    ...
    getArticleComments,
} from '../../model/slice/ArticleDetailsCommentsSlice.ts/ArticleDetailsCommentsSlice.ts';
...
const ArticleDetailsPage = ({ className }: ArticleDetailsPageProps) => {
    const classNames = clsx(cls.ArticleDetailsPage, className);
        ...
        <DynamicModuleFolder reducers={initialReducer} removeAfterUnmount={true}>
            <Page>
                <section className={classNames}>
                    <Button
                        className={cls.backToArticlePageBTN}
                        theme='outline'
                        onClick={onBackToArticlePage}
                    >
                        {t('Назад к списку')}
                    </Button>
