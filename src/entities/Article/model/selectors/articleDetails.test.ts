...
describe('selectors Article test', () => {
    it('getArticleDetailsData should return data', () => {
    ...
    it('getArticleDetailsData should work with empty', () => {
        const state: DeepPartial<StateSchema> = {
            articleDetails: {},
        };
        expect(getArticleDetailsData(state as StateSchema)).toEqual(undefined);
    });
    it('getArticleDetailsError should return error', () => {
        const state: DeepPartial<StateSchema> = {
            articleDetails: {
                error: 'error',
            },
    ...
    it('getArticleDetailsLoading should return isLoading', () => {
        const state: DeepPartial<StateSchema> = {
            articleDetails: {
                isLoading: false,
            },
